 ...
 * Generated-By: http://borischerny.com/json-schema-to-typescript-browser/
 */

export interface Yarnrc extends JSONSchemaForYarnrcFiles {}
 ...
 */
interface JSONSchemaForYarnrcFiles {
  /**
  ...
  logFilters?: {
     ...
     */
    level?: null | ("discard" | "info" | "warning" | "error");
    [k: string]: unknown;
  }[];
  /**
  ...
  /**
   * Defines whether workspaces are allowed to require themselves - results in creation of self-referencing symlinks. This setting can be overriden per-workspace through the [`installConfig.selfReferences` field](/configuration/manifest#installConfig.selfReferences).
   */
   ...
   */
  nodeLinker?: (string | ("pnp" | "pnpm" | "node-modules")) & string;
  /**
   ...
   */
  pnpMode?: (string | ("strict" | "loose")) & string;
  /**
